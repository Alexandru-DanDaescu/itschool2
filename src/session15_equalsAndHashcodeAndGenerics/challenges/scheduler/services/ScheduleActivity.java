package session15_equalsAndHashcodeAndGenerics.challenges.scheduler.services;

import session15_equalsAndHashcodeAndGenerics.challenges.scheduler.domain.Activities;
import session15_equalsAndHashcodeAndGenerics.challenges.scheduler.domain.Day;
